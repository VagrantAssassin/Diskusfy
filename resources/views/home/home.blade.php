    ...
    <section class="bg-gray-900 dark:bg-gray-900 py-8 lg:py-16 antialiased ">
        <div class="mx-auto max-w-screen-lg px-4 2xl:px-0">
            <div class="lg:flex lg:items-center lg:justify-between lg:gap-4">
                <h2 class="shrink-0 text-xl font-semibold text-gray-900 dark:text-white sm:text-2xl">Questions
                    ({{ count($diskusis) }})</h2>
                ...
                <div class="-my-6 divide-y divide-gray-200 dark:divide-gray-800">
                    @foreach ($diskusis as $diskusi)
                        <div class="space-y-4 py-6 md:py-8">
                            ...
                            <p class="text-base font-normal text-gray-500 dark:text-gray-400">{{ $diskusi->isi_diskusi }}
                            </p>
