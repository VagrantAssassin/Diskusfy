    ...
    <div class="bg-white shadow-md rounded-lg p-6 w-full h-screen overflow-auto">
        ...
        <div class="space-y-4">
            ...
            @foreach ([
                ...
                ['username' => 'User456', 'judul' => 'Apa perbedaan antara Livewire dan Vue.js?', 'isi' => 'Livewire dan Vue.js adalah dua teknologi yang berbeda dalam membangun aplikasi interaktif di Laravel. Livewire bekerja tanpa JavaScript secara eksplisit, sedangkan Vue.js berbasis JavaScript dan lebih fleksibel dalam manipulasi DOM.'],
                ...
                <div class="bg-[#FBF7F4] p-4 rounded-lg shadow">
                    <div class="flex items-center mb-2">
                        <div class="bg-[#77B254] h-10 w-10 rounded-full flex items-center justify-center text-white font-bold">{{ substr($diskusi['username'], 0, 1) }}</div>
