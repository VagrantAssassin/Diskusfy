        ...
        <div class="bg-white shadow-md rounded-lg p-6 w-full h-screen overflow-auto">
            ...
            <div class="mt-2 border-t border-[#000001] pt-2">
                <div class="bg-[#FBF7F4] p-3 rounded-lg flex items-start mt-3">
                    <p class="mt-1 text-[#000001]">
                        ...
                        fjawopfnma/pfowja'pwodjawdjef/elnvawepoihdwa'dpoajkskdmas/klnaeoijawpodfjaelf
                    </p>
                </div>
            </div>
            ...
            <div class="bg-[#FBF7F4] p-3 rounded-lg shadow-lg mt-3">
                <div class="flex items-center ">
                    <input type="text" class="w-full bg-[#FFFFFF] text-[#000001] p-2 rounded-lg"
                            ...
                            <div class="flex items-center space-x-2">
                                ...
                                <button id="upvote"
                                    ...
                                    <svg id="upvoteIcon" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        viewBox="0 0 24 24" fill="currentColor" class="text-[#B3B3B3]">
