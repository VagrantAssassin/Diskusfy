...
<head>
    ...
    <script src="{{asset('js/new_discussion.js')}}"></script>
</head>
<body class="bg-gray-100">
    <div class="flex items-center justify-center min-h-screen">

        <!-- Form Content -->
        <main class="w-full max-w-2xl p-6 bg-white rounded-lg shadow-md mx-auto" x-data="discussionForm">
                    ...
                    <div class="flex gap-2 flex-wrap">
                        <template x-for="(category, index) in categories" :key="index">
                            <span class="bg-gray-500 text-white px-3 py-2 rounded-lg flex items-center text-lg">
                                ...
                                <button type="button" class="ml-2 text-white" @click="removeCategory(index)">&times;</button>
                            </span>
                        </template>
                    </div>
            ...
            <div x-show="showModal" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
                <div class="bg-gray-700 text-white p-6 rounded-lg w-96">
                    ...
                    <div class="flex justify-between mt-4">
                        ...
                        <button type="button" class="bg-green-600 px-4 py-3 rounded-lg text-lg" @click="addCategory">
                            Tambah
                        </button>
                    </div>
                </div>
