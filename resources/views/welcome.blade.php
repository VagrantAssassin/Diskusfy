...
<body>
    ...
    <div class="flex flex-col">
        <nav class="dark:bg-gray-800 border-gray-200 dark:bg-gray-800">
            <div class="max-w-screen-xl flex flex-wrap items-center justify-center mx-auto px-4 py-2">
                ...
                {{-- <a href="{{ route('export.diskusi') }}" class="text-white bg-green-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-2 ml-2 dark:bg-green-700 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Export to Excel</a> --}}
            </div>
        </nav>
        <div class="w-full">
            <aside id="logo-sidebar"
                ...
                <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
                    <a href="#" onclick="location.reload(); return false;" class="flex items-center ps-2.5 mb-5">
                        <span
                            class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Diskusfy</span>
                    </a>
    ...
    <div id="chatbotPopup"
        class="hidden fixed bottom-16 right-5 w-80 h-96 bg-white shadow-lg rounded-lg flex flex-col">
