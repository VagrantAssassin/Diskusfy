...
=======
        <div class="max-w-screen-xl flex flex-wrap items-center justify-center mx-auto px-4 py-2">
            <div class="flex items-center relative">
                ...
                <button type="button" class="text-white bg-green-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-2 ml-2 dark:bg-green-700 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Search</button>
            </div>
        </div>
    </nav>
    <div class="w-full">
...
>>>>>>> 08d69ccb3192ace3c8461c3c431adec2dfd1a71d
          </div>
          <button type="button"
