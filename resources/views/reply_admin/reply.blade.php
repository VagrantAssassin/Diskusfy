...
<body class="bg-white dark:bg-gray-800">
  ...
  <div class="p-4 sm:ml-64">
    <h1 class="text-2xl font-semibold text-gray-800 dark:text-white">Daftar Balasan</h1>
    <p class="text-gray-600 dark:text-gray-300 mb-4">Berikut adalah daftar balasan yang terdaftar di sistem.</p>

    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
      <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
          <tr>
            <th class="px-6 py-3">ID Balasan</th>
            <th class="px-6 py-3">Parent ID</th>
            <th class="px-6 py-3">ID Diskusi</th>
        ...
        <tbody id="replyTableBody">
          <!-- Data balasan akan dimuat oleh replyAdmin.js -->
        </tbody>
      </table>
    </div>
  </div>
  ...
  <div id="editModal" class="hidden fixed inset-0 bg-gray-600 bg-opacity-50 flex justify-center items-center">
    <div class="bg-white p-5 rounded-lg shadow-lg w-96">
      ...
      <label class="block mb-2">Parent ID</label>
      <input type="number" id="editParentId" class="w-full border px-2 py-1 rounded">
      <label class="block mb-2 mt-2">ID Diskusi</label>
      <input type="number" id="editIdDiskusi" class="w-full border px-2 py-1 rounded">
      <label class="block mb-2 mt-2">UID</label>
      <input type="text" id="editUid" class="w-full border px-2 py-1 rounded">
      <label class="block mb-2 mt-2">Isi Balasan</label>
      <textarea id="editIsiBalasan" class="w-full border px-2 py-1 rounded"></textarea>
      <div class="flex justify-end mt-4">
        ...
        <button onclick="updateReply()" class="bg-blue-500 text-white px-4 py-2 rounded">Save</button>
      </div>
    </div>
  </div>

  <script src="{{ asset('js/replyAdmin.js') }}"></script>
