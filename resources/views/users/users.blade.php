      ...
      <ul class="space-y-2">
        ...
        <li>
          ...
          <ul id="dropdown-pages" class="hidden py-2 space-y-2">
            ...
            <li>
              <a href="#" class="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Category</a>
            </li>
            <li>
              <a href="#" class="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Discussion</a>
            </li>
            <li>
              <a href="#" class="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Reply</a>
            </li>
          </ul>
        </li>
        <li>
   ...
   <div class="p-4 sm:ml-64">
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
      <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        ...
        <!-- Pastikan ID yang digunakan di sini sama dengan yang dirujuk di JS -->
        <tbody id="userTableBody">
          <!-- Data akan diisi oleh users.js -->
        </tbody>
      </table>
    </div>
  </div>
