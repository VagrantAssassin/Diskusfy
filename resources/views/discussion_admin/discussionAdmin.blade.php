...
<div class="p-4 sm:ml-64">
    <h1 class="text-2xl font-semibold text-gray-800 dark:text-white">Daftar Diskusi</h1>
    <p class="text-gray-600 dark:text-gray-300 mb-4">Berikut adalah daftar diskusi yang terdaftar di sistem.</p>

    <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
      <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
          <tr>
            <th scope="col" class="px-6 py-3">ID Diskusi</th>
            <th scope="col" class="px-6 py-3">Kategori</th>
            <th scope="col" class="px-6 py-3">UID</th>
            <th scope="col" class="px-6 py-3">Judul</th>
            <th scope="col" class="px-6 py-3">Isi Diskusi</th>
            <th scope="col" class="px-6 py-3">Aksi</th>
          </tr>
        </thead>
        <!-- Data diskusi akan dimuat melalui JavaScript (discussionAdmin.js) -->
  ...
  <div id="editModal" class="hidden fixed inset-0 bg-gray-600 bg-opacity-50 flex justify-center items-center">
    <div class="bg-white p-5 rounded-lg shadow-lg w-96">
      <h2 class="text-lg font-bold mb-3">Edit Diskusi</h2>
      <!-- Input tersembunyi untuk menyimpan ID Diskusi -->
      <input type="hidden" id="editIdDiskusi">
      <label class="block mb-2">ID Kategori</label>
      <input type="number" id="editIdKategori" class="w-full border px-2 py-1 rounded">
      <label class="block mb-2 mt-2">UID</label>
      <input type="text" id="editUid" class="w-full border px-2 py-1 rounded">
      <label class="block mb-2 mt-2">Judul</label>
      <input type="text" id="editJudul" class="w-full border px-2 py-1 rounded">
      <label class="block mb-2 mt-2">Isi Diskusi</label>
      <textarea id="editIsiDiskusi" class="w-full border px-2 py-1 rounded"></textarea>
      <div class="flex justify-end mt-4">
        ...
        <button onclick="updateDiscussion()" class="bg-blue-500 text-white px-4 py-2 rounded">Save</button>
      </div>
    </div>
  </div>
  <script src="{{ asset('js/discussionAdmin.js') }}"></script>
